...
import styles from './SingleCellVRectangular.module.css'
...
const SingleCellVRectangular = ({ sectionIndex, productIndex, ignoreModifier, showIconPlus }: ISingleCellProps) => {
