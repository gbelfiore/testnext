...
import styles from './SingleCellPbHorizontal.module.css'
...
const SingleCellPbHorizontal = ({ sectionIndex, productIndex, ignoreModifier, showIconPlus }: ISingleCellProps) => {
