...
import styles from './SingleCellHSquaredOverlap.module.css'
...
const SingleCellHSquaredOverlap = ({ sectionIndex, productIndex, ignoreModifier, showIconPlus }: ISingleCellProps) => {
...
export { SingleCellHSquaredOverlap }
