...
import styles from './SingleCellVSquaredOverlap.module.css'
...
const SingleCellVSquaredOverlapComponent = ({
  sectionIndex,
  productIndex,
  ignoreModifier,
  showIconPlus,
...
export const SingleCellVSquaredOverlap = memo(SingleCellVSquaredOverlapComponent)
