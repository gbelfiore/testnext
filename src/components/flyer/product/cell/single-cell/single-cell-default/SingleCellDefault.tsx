...
import styles from './SingleCellDefault.module.css'
...
const SingleCellDefaultComponent = ({ sectionIndex, productIndex, ignoreModifier, showIconPlus }: ISingleCellProps) => {
    ...
    <div className={styles.singleCellDefault}>
      ...
      <div className={styles.info}>
        <div className={styles.description}>
          <ProductInfo
            titleClassName={classNames('break-words', product.brandImage ? 'line-clamp-2' : 'line-clamp-3')}
            descriptionClassName="line-clamp-3 break-words"
...
export const SingleCellDefault = memo(SingleCellDefaultComponent)
